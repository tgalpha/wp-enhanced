...
// [PropertyNames]
extern const char* const szBoolParamAsCheckbox;
extern const char* const szIntParamAsComboBox;
extern const char* const szFloatParamAsSlider;
// [/PropertyNames]

/// See https://www.audiokinetic.com/library/edge/?source=SDK&id=plugin__dll.html
/// for the documentation about Authoring plug-ins
class TestPluginPlugin final
...
DECLARE_AUDIOPLUGIN_CONTAINER(TestPlugin);	// Exposes our PluginContainer structure that contains the info for our plugin
